 ...
 * @author ACER
 */
public class ServletWithdrwal extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletWithdrwal.class.getName()).log(Level.SEVERE, null, ex);
